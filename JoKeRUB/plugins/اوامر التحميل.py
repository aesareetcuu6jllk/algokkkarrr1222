    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            try:
                ...
                # Debug - لإظهار معلومات الفيديو، فعّل هذه السطر إذا أردت:
                # await event.reply(f"DEBUG: {json.dumps(video_info, ensure_ascii=False, indent=2)}")
            ...
            # البحث عن الملفات بأي امتداد فيديو أو صوت دون التقيد بالعنوان فقط
